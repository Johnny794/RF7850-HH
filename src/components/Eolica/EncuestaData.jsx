export const EncuestaData = [
    {
        id: 0,
        question: `1. Considera usted que le ha sido útil esta herramienta para  manejo del radio Harris M-HH7850?`,
        options: [`a. Si`, `b. No`],
        answer: ``
    },
    {
        id: 1,
        question: `2. Cuál es su grado de satisfacción en la informacion recibida por medio de este aplicativo en el manejo del radio Harris M-HH7850. `,
        options: [`5 Muy satisfecho`, `4 Satisfecho`, `3 Normal`, `2 Poco Satisfecho`, `1 Nada Satisfecho`],
        answer: ``
    },
    {
        id: 2,
