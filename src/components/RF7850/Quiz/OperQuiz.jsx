...
export default class Quiz extends Component {
  ...
  loadQuiz = () => {
    ...
    this.setState(() => {
        return {
            question: OperQuizData[currentIndex].question,
            options : OperQuizData[currentIndex].options,
            answer: OperQuizData[currentIndex].answer          
        }
    }
    )
}
                            ...
                            <div className="col" >
                                { this.state.quizEnd ?
                                 <div className="card text-dark bg-white" style={styles.cardq} >      
                                    ...
                                    <span className="text-center" >{`Pregunta ${currentIndex+1} de ${OperQuizData.length}`}</span>
                                    ...
                                    {currentIndex < OperQuizData.length -1 &&  
