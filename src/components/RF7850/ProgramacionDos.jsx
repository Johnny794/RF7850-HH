            ...
            <div style={styles.card} className="card m-1 text-white bg-dark" >
                ...
                <Carousel labels='none' showStatus={false} >                                                    
                    <div className="alert col bg-primary"  role="alert" style={{height:500}} >
                            ...
                            <div align='center' >
                                <img src="./assets/n1.png" alt='imagen'  className='m-5' style={{width:700, borderRadius:15}} />                          
                            </div>
                    </div>
                    <div className="alert col bg-primary"  role="alert"  style={{height:450}} >
                            ...
                            <div align='center' >
                                    <img src="./assets/n2.png" alt='imagen'  className='m-5' style={{width:700, borderRadius:15}}/>                          
                                </div>
                    </div>
                    <div className="alert col bg-primary"  role="alert" style={{height:500}} >
                            <div className="row alert alert-info "  align='left' >
                            <ul className='m-3' >
                                ...
                                <div align='center'>
                                    <img src="./assets/n3.png" alt='imagen'  className='m-5' style={{width:700, borderRadius:15}} />                          
                                </div> 
                    </div>
                    <div className="alert col bg-primary" role="alert" style={{height:500}} >
                            <div className="row alert alert-info "  align='left' >
                            <ul className='m-3' >                                
                                ...
                                <div >
                                    <img src="./assets/n3.png"  alt='imagen'  className='m-5' style={{width:800, borderRadius:15}} />                          
                                </div>                                 
                    </div> 
                    <div className="alert col bg-primary"  role="alert" style={{height:500}} >
                            <div className="row alert alert-info " align='left' >
                            <ul className='m-3' >                                
                                ...
                                <div >
                                    <img src="./assets/n4.png" alt='imagen'  className='m-5' style={{width:800, borderRadius:15}} />                          
                                </div>                                 
                    </div>   
                    <div className="alert col bg-primary"  role="alert" style={{height:500}} >
                            <div className="row alert alert-info "  align='left' >
                            <ul className='m-3' >
                                ...
                                <div >
                                    <img src="./assets/n5.png" alt='imagen'  className='m-5' style={{width:800, borderRadius:15}} />                          
                                </div>                                 
                        </div>       
                     ...
                     <div className="alert col bg-primary"  role="alert" style={{height:500}} >
                            ...
                            <ul className='m-3' >
                                ...
                                <div >
                                    <img src="./assets/n6.png" alt='imagen'  className='m-5' style={{width:800, borderRadius:15}} />
                                    <img src="./assets/n7.png" alt='imagen'  className='m-5' style={{width:340, borderRadius:15}} />                          
                                </div>                                 
                    </div>                                                  
                </Carousel>            
                </div>
